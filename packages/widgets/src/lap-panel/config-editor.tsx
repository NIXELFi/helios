...
export function LapPanelConfigEditor({ config, onChange }: WidgetConfigEditorProps<LapPanelConfig>) {
  ...
  return (
    <div className="p-2 text-xs text-helios-text flex flex-col gap-2">
      ...
      <div className="text-[10px] text-helios-dim mt-2">
      ...
      {hasLegacy && (
        <button
          className="self-start mt-2 px-2 py-0.5 text-[10px] uppercase tracking-wider text-helios-dim hover:text-[#EF5350] border border-helios-line hover:border-[#EF5350]"
          onClick={() => set("laps", [])}
