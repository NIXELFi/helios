  ...
  return (
    <div className="p-2 text-xs text-[#D8DCE2] flex flex-col gap-2">
      <label className="flex items-center gap-2">
        <span className="text-[10px] uppercase tracking-wider text-[#9097A0] w-20">channel</span>
      ...
      <label className="flex items-center gap-2">
        <span className="text-[10px] uppercase tracking-wider text-[#9097A0] w-20">y scale</span>
      ...
      <label className="flex items-center gap-2">
        <span className="text-[10px] uppercase tracking-wider text-[#9097A0] w-20">freq scale</span>
      ...
      <label className="flex items-center gap-2">
        <span className="text-[10px] uppercase tracking-wider text-[#9097A0] w-20">f max</span>
        ...
        <span className="text-[10px] text-[#9097A0]">Hz (0 = auto)</span>
      </label>
    </div>
  );
}
